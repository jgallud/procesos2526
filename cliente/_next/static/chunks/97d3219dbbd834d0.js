...
to {
  ...
  animation: ${V} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?o.createElement(W,null,t):t:"blank"===a?null:o.createElement(q,null,o.createElement(H,{...r}),"loading"!==a&&o.createElement(K,null,"error"===a?o.createElement(M,{...r}):o.createElement(U,{...r})))},Z=h("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
